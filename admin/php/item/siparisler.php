            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Ürünler
                        <a href="item-editor.html" class="btn btn-primary btn-sm rounded-s">  Ekle </a>
                        <!--
 -->
                        <div class="action dropdown">
                            <button class="btn  btn-sm rounded-s btn-secondary dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Düzenleme... </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu1">

                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#confirm-modal">
                                    <i class="fa fa-close icon"></i>Sil</a>
                            </div>
                        </div>
                    </h3>
